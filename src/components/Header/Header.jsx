        ...
        <div>
          ...
          >
            <span className="pr-12 md:pr-0">
              {open ? <XMarkIcon className="h-7 w-6 mt-7  text-btnSecondary md:hidden  cursor-pointer" /> : <Bars3Icon className="h-7 w-6 mt-7  text-btnPrimary  cursor-pointer md:hidden" />}
            </span>
          </div>
